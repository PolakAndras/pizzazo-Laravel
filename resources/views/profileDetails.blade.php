  ...
  <body>
    ...
    <div class="container">
        <form action="" method="POST">
            @csrf
            <h3 class="text-center my-5">Profil módosítása</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-6 alert alert-warning shadow-lg">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email_confirm" name="email_confirm" value="{{ old('email_confirmation', auth()->user()->email)}}">
                ...
                <div class="col-md-6 alert alert-info shadow-lg">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="zip" name="zip" maxlength="4" pattern="\d{4}" inputmode="numeric" value="{{ old('zip', auth()->user()->zip)}}">
                        @error('zip')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="houseNumber" name="houseNumber" value="{{ old('houseNumber', Auth::user()->houseNumber)}}">
                        @error('houseNumber')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="floor" name="floor_door" value="{{ old('floor_door', auth()->user()->floor_door)}}">
                        @error('floor')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="bell" name="doorbell" value="{{ old('doorbell', Auth::user()->doorbell)}}">
                        @error('bell')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="elseData" name="elseData" maxlength="200" rows="3" style="max-height: 5rem">{{ old('elseData', auth()->user()->elseData)}}</textarea>
                        @error('elseData')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
            ...
            <button type="submit" class="btn btn-primary my-3 d-block mx-auto" style="max-width: 10rem">Módosítás</button>
        </form>
    </div>
