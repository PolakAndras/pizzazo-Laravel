        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
                <div class="bg-white rounded p-3">
                    <h5 class="text-center mb-3">Pizzák</h5>
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body d-flex align-items-center p-2">
                                    ...
                                    <div class="ms-3">
                                        <h6 class="mb-1">Sonkás pizza</h6>
                                        <p class="mb-1">sajt, sonka</p>
                                        <p class="mb-0">2490 Ft</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-center p-2">
                                    <img src=""
                                        style="width:80px; height:80px; object-fit:cover;" class="rounded">
                                    <div class="ms-3">
                                        <h6 class="mb-1">Hawaii pizza</h6>
                                        <p class="mb-1">ananász, sajt, sonka</p>
                                        <p class="mb-0">2590 Ft</p>
                                    </div>
                                </div>
                            </div>
                        </div>
